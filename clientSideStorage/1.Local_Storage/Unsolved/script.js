...
function renderLastRegistered() {
  ...
  var email = localStorage.getItem("strEmail");
  var password = localStorage.getItem("strPassword");
...
signUpButton.addEventListener("click", function(event) {
  ...
  var strEmail = localStorage.getItem("strEmail");
  ...
  if (email === "") {
    ...
    localStorage.setItem("strPassword", password);
  }
});
